...
class PythonRunner : public QObject {
  ...
  public:
    ...
    /// Build the standard Python process environment used by Python subprocess
    /// spawns. Sets PYTHONIOENCODING, PYTHONDONTWRITEBYTECODE,
    /// PYTHONUNBUFFERED, FINCEPT_DATA_DIR and PYTHONPATH (derived from scripts_dir()).
